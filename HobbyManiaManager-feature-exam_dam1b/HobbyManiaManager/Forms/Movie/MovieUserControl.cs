...
namespace HobbyManiaManager
{
    public partial class MovieUserControl : UserControl
    {
        ...
        public void Load(Movie movie)
        {
            ...
            this.labelOriginalTitle.Location = new Point(this.labelOriginalTitle.Location.X, this.labelTitle.Bottom + 15);
            ...
            this.labelGenres.Location = new Point(this.labelGenres.Location.X, this.labelTitle.Bottom + 5);
